...
#критерії пошуку у вигляді кортежу (рік ≥, об'єм двигуна ≥, ціна ≤)
search_criteria = (2017, 1.6, 36000)

first_try_list = []
for expeced_car in car_data:
  if car_data[expeced_car][1] >= search_criteria[0] and car_data[expeced_car][2] >= search_criteria[1] and car_data[expeced_car][4] <= search_criteria[2]:
  #if search_criteria[0] >= car_data[expeced_car][1] and search_criteria[1] >=car_data[expeced_car][2]  and search_criteria[2] <=car_data[expeced_car][4]:
    first_try_list.append(expeced_car)
first_try_list.sort(key=lambda price: car_data[price][4])
print(first_try_list[0:5])
